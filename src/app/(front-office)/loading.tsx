// Composant de loading moderne et accessible pour le front-office
export default function FrontOfficeLoading() {
  return (
    // Fond dégradé doux, centre le contenu à l'écran
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-[#e0f1fc] via-[#f9fafb] to-[#fdf6ec]">
      <div className="bg-white/90 shadow-xl rounded-2xl px-8 py-10 max-w-xs w-full text-center space-y-6">
        {/* Spinner animé, accessible pour les lecteurs d'écran */}
        ...
        {/* Astuce UX : rassurer l'utilisateur */}
